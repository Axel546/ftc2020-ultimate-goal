 ...
 */
@TeleOp
public class DrivePowershot extends LinearOpMode {
    ...
    Vector2d towerVector = new Vector2d(125,-4.5);
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            switch (currentMode) {
                case DRIVER_CONTROL:
                    ...
                    {
                        Trajectory trajPowershot1 = drive.trajectoryBuilder(new Pose2d())
                                .addTemporalMarker(0,()->{
                                    drive.outtakeMotor.setPower(1);
                                })
                                .strafeTo(new Vector2d(0,-7))
                                .build();
                        Trajectory trajPowershot2 = drive.trajectoryBuilder(trajPowershot1.end())
                                .strafeTo(new Vector2d(0,-15))
                                .build();
                        Trajectory trajPowershot3 = drive.trajectoryBuilder(trajPowershot2.end())
